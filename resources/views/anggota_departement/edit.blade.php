...
<div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
    ...
    <div class="mx-4 md:mx-6 lg:mx-16 bg-slate-200 p-4 md:p-8  rounded-lg shadow-lg">
        ...
        @endif
        <form action="/anggota_departement-edit/{{ $anggotaDepartement->id }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <select id="departement_id" name="departement_id"
                    ...
                    <option value="{{ $departement->id }}" @if ($anggotaDepartement->departement_id == $departement->id)
                        selected @endif>
                        {{ $departement->nama }}
                    </option>
                    @endforeach
            ...
            <div class="mb-4">
                ...
                <input type="text" id="prodi" name="prodi"
                    class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('prodi', $anggotaDepartement->prodi) }}">
            </div>
